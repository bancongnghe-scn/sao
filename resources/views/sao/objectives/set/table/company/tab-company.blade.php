<div class="tab-pane show active" id="tab-company">
    <div class="row mb-3">
        <div class="row col-12 col-sm-12 col-lg-12 col-xl-9" style="margin-right: auto;">
            ...
            {{--                            <button class="btn border w-100 btn-filter">--}}
            {{--                                Bộ lọc--}}
            ...
            <div class="col-xl-2 col-md-2">
                <input class="form-control" placeholder="Tên bộ mục tiêu">
            </div>
        </div>
            ...
            <div class="bg-white">
                <div class="table-responsive">
                    <table class="table table-hover table-bordered table-contract">
                        <thead class="custom">
                        <tr>
                            <th class="text-center column-sst">STT</th>
                            <th class="text-center">Tên bộ mục tiêu</th>
                        ...
                        <tr>
                            ...
                            <td class="text-left align-middle">
                                <a href="/sao/objectives/set/detail-company" class="text-primary" target="_blank">
                                    Mục tiêu công ty năm 2025
                                </a>
                            </td>
                            <td class="text-left align-middle">
                                2024
